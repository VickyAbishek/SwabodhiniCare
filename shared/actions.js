...
var SC_Actions = (function () {
  ...
  var MESSAGES = {
    ...
    NETWORK_ERROR: ["Can't reach the server. Check the Wi-Fi or mobile data, then try again.", "சர்வரை அணுக முடியவில்லை. Wi-Fi அல்லது மொபைல் டேட்டாவைச் சரிபார்த்து மீண்டும் முயற்சிக்கவும்."],
